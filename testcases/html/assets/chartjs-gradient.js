            ...
            case "bar":
                if (colors && colors.length && isString(colors[0])) {
                    Object.entries(colors).forEach(([, color], index) => {
                        ...
                        _bargradient.addColorStop(.5, getRgbaColor(color, 50));
    ...
    var plugin_gradient = {
        ...
        beforeDatasetsUpdate(chart) {
            ...
            if (chart.options.gradientcolor && chart.options.gradientcolor.type !== undefined) {
                ...
                chart.data.datasets[0].backgroundColor = backgroundGradient(ctx, chart.options.gradientcolor.type, area, colors);
            } else {
