...
type ScaleOptions<SCALES extends ScaleType = ScaleType> = DeepPartial<
  { [key in ScaleType]: { type: key } & ScaleTypeRegistry[key]['options'] }[SCALES]
>;

type DatasetChartOptions<TYPE extends ChartType = ChartType> = {
  [key in TYPE]: {
    datasets: ChartTypeRegistry[key]['datasetOptions'];
  };
};

type ScaleChartOptions<TYPE extends ChartType = ChartType> = {
  scales: {
    [key: string]: ScaleOptions<ChartTypeRegistry[TYPE]['scales']>;
  };
};

type ChartOptions<TYPE extends ChartType = ChartType> = DeepPartial<
  CoreChartOptions &
  PluginChartOptions &
  ElementChartOptions &
...
type DefaultDataPoint<TYPE extends ChartType> = ChartType extends TYPE ? unknown[] : DistributiveArray<
...
interface ChartMeta<E extends Element = Element, DSE extends Element = Element> {
	type: string;
...
export { InteractionModeFunction as $, DateAdapter as A, BarControllerDatasetOptions as B, ControllerDatasetOptions as C, DoughnutControllerDatasetOptions as D, Animation as E, AnimationEvent$1 as F, Animator as G, Animations as H, ChartMeta as I, ActiveDataPoint as J, ActiveElement as K, LineControllerDatasetOptions as L, Chart as M, ChartItem as N, UpdateMode as O, ParsingOptions as P, DatasetController as Q, RadarControllerDatasetOptions as R, ScatterControllerDatasetOptions as S, DatasetControllerChartComponent as T, UpdateModeEnum as U, Defaults as V, defaults as W, Element as X, InteractionOptions as Y, InteractionItem as Z, _adapters as _, BarControllerChartOptions as a, TextAlign as a$, InteractionModeMap as a0, InteractionMode as a1, Interaction as a2, LayoutPosition as a3, LayoutItem as a4, layouts as a5, PluginService as a6, Plugin as a7, ChartComponentLike as a8, Registry as a9, PointElement as aA, BarProps as aB, BarOptions as aC, BorderRadius as aD, BarHoverOptions as aE, BarElement as aF, ElementChartOptions as aG, Color as aH, ChartEvent as aI, Point as aJ, ChartComponent as aK, TimeUnit as aL, ChartArea as aM, ScriptableContext as aN, Scriptable as aO, ScriptableOptions as aP, ScriptableAndArray as aQ, ScriptableAndArrayOptions as aR, CoreInteractionOptions as aS, HoverInteractionOptions as aT, CoreChartOptions as aU, EasingFunction as aV, AnimationCommonSpec as aW, AnimationPropertySpec as aX, AnimationSpecContainer as aY, AnimationOptions as aZ, FontSpec as a_, registry as aa, Tick as ab, CoreScaleOptions as ac, Scale as ad, ScriptAbleScaleContext as ae, ScriptAbleScale as af, Ticks as ag, TypedRegistry as ah, VisualElement as ai, CommonOptions as aj, CommonHoverOptions as ak, Segment as al, ArcProps as am, ArcOptions as an, ArcHoverOptions as ao, ArcElement as ap, LineProps as aq, LineOptions as ar, LineHoverOptions as as, LineElement as at, PointProps as au, PointStyle as av, PointOptions as aw, PointHoverOptions as ax, PointPrefixedOptions as ay, PointPrefixedHoverOptions as az, BarController as b, BasePlatform as b0, BasicPlatform as b1, DomPlatform as b2, Filler as b3, FillerOptions as b4, FillTarget as b5, ComplexFillTarget as b6, FillerControllerDatasetOptions as b7, Legend as b8, LegendItem as b9, TimeScale as bA, TimeSeriesScale as bB, RadialLinearScaleOptions as bC, RadialLinearScale as bD, DeepPartial as bE, DistributiveArray as bF, CartesianScaleTypeRegistry as bG, RadialScaleTypeRegistry as bH, ScaleTypeRegistry as bI, ScaleType as bJ, ChartTypeRegistry as bK, ChartType as bL, ScaleOptions as bM, DatasetChartOptions as bN, ScaleChartOptions as bO, ChartOptions as bP, DefaultDataPoint as bQ, ChartDatasetProperties as bR, ChartDataset as bS, ChartData as bT, ChartConfiguration as bU, LegendElement as ba, LegendOptions as bb, LegendChartOptions as bc, Title as bd, TitleOptions as be, TitleChartOptions as bf, TooltipAlignment as bg, TooltipModel as bh, Tooltip as bi, TooltipCallbacks as bj, TooltipPlugin as bk, TooltipOptions as bl, TooltipChartOptions as bm, TooltipItem as bn, PluginOptions as bo, PluginChartOptions as bp, GridLineOptions as bq, TickOptions as br, CartesianScaleOptions as bs, CategoryScaleOptions as bt, CategoryScale as bu, LinearScaleOptions as bv, LinearScale as bw, LogarithmicScaleOptions as bx, LogarithmicScale as by, TimeScaleOptions as bz, BubbleControllerDatasetOptions as c, BubbleDataPoint as d, BubbleController as e, LineControllerChartOptions as f, LineController as g, ScatterDataPoint as h, ScatterControllerChartOptions as i, ScatterController as j, DoughnutAnimationOptions as k, DoughnutControllerChartOptions as l, DoughnutDataPoint as m, DoughnutController as n, PieControllerDatasetOptions as o, PieControllerChartOptions as p, PieAnimationOptions as q, PieDataPoint as r, PieController as s, PolarAreaControllerDatasetOptions as t, PolarAreaAnimationOptions as u, PolarAreaControllerChartOptions as v, PolarAreaController as w, RadarControllerChartOptions as x, RadarController as y, DateAdapterBase as z };
