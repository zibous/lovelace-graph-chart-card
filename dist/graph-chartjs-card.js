/*!
 * home-assistant lovelace graph-chartjs-card v0.0.1
 * https://github.com/zibous/lovelace-graph-chart-card
 * (c) 2020 Peter Siebler
 * Released under the MIT license
 * Graph card for Home Assistant Lovelace UI based on chart.js 
 * 
 * Used plugins
 * Chart.js v2.9.4
...
}(commonjsGlobal, (function (moment) {moment = moment && moment.hasOwnProperty('default') ? moment['default'] : moment;
function createCommonjsModule(fn, module) {
	return module = { exports: {} }, fn(module, module.exports), module.exports;
}
...
var chartjsPluginColorschemes = createCommonjsModule(function (module, exports) {
/*!
 ...
 */
(function (global, factory) {
 module.exports = factory(Chart) ;
}(commonjsGlobal, function (Chart) {Chart = Chart && Chart.hasOwnProperty('default') ? Chart['default'] : Chart;
var
